                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col-md-5">
                            <div className="contact-info">
                                ...
                                <h4><i className="fa fa-map-marker" />123 E Shop, Los Angeles, CA, USA</h4>
                                <h4><i className="fa fa-envelope" />email@example.com</h4>
                                <h4><i className="fa fa-phone" />+123-456-7890</h4>
